                    ...
                    <div class="col-sm-12 col-xl-6 col-xl-special">
                        <form action="events.php" method="POST" enctype="multipart/form-data">
                            <div class="bg-secondary rounded h-100 p-4">
                                <h6 class="mb-4">Event Details</h6>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="file" class="form-control" name="event_image"
                                        placeholder="Event Photo" required>
                                    <label for="floatingPhoto">Event Photo</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="datetime-local" class="form-control" name="expiry_time"
                                        placeholder="Event Expire Date" required>
                                    <label for="floatingDate">Event Expire Date</label>
                                </div>
